...
public class Main {
    public static void main(String[] args) {
        ...
        // Change the static field after serialization
        CustomClass.setField1("modifiedExample");
        ...
        System.out.println("Static field after deserialization: " + CustomClass.getField1());
    }
}
